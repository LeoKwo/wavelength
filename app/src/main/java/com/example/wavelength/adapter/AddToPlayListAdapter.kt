...
//    var onPlayListEditClickListener: (playList: PlayList) -> Unit = {_ ->}
    ...
    inner class AddToPlayListViewHolder(val binding: ItemAddToPlayListBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AddToPlayListViewHolder {
        ...
        return AddToPlayListViewHolder(ItemAddToPlayListBinding.inflate(
...
//            }
            ...
            ivAdd.setColorFilter(ContextCompat.getColor(context, R.color.blue))
            ivAdd.visibility = View.VISIBLE
            ivAdd.setOnClickListener{onPlayListClickListener(playList)}
